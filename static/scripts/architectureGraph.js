// ArchitectureGraph represents a graph derived from a solution
function ArchitectureGraph(model, view, domain, architecture, version) {
  // member variables
  ...
  this.architecture  = architecture  // name of the architecture
  this.version       = version       // version of the architecture
...
ArchitectureGraph.prototype.calculateComponents = function() {
...
ArchitectureGraph.prototype.calculateElements = function() {
  var elements1 = this.model.Architecture.Elements
...
ArchitectureGraph.prototype.calculateClusters = function() {
...
ArchitectureGraph.prototype.calculateRelationships = function() {
  var elements      = this.Elements
...
ArchitectureGraph.prototype.calculateNodes = function() {
  var elements = this.Elements
...
ArchitectureGraph.prototype.calculateDestinations = function() {
  var elements     = this.Elements
  var nodes        = this.Nodes
...
ArchitectureGraph.prototype.calculateSources = function() {
  var elements = this.Elements
  var nodes    = this.Nodes
...
ArchitectureGraph.prototype.sortSources = function() {
  var nodes = this.Nodes
...
ArchitectureGraph.prototype.sortDestinations = function() {
  var nodes = this.Nodes
...
ArchitectureGraph.prototype.sortNodes = function() {
  var nodes  = this.Nodes
  var list   = []
  var queue1 = []
  var queue2 = []
...
ArchitectureGraph.prototype.calculateEdges = function() {
  var nodes        = this.Nodes
...
ArchitectureGraph.prototype.calculateDimensions = function() {
  vg = this.view.graph
